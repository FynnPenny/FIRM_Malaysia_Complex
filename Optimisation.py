...
parser.add_argument('-n', default='SB', type=str, required=False, help='APG_Full, APG_PMY_Only, APG_BMY_Only, APG_MY_Isolated, SB, SW...')
...
""" def F(x):
    ...
    GHydro = resolution * hydro_flexProportion * (Max_deficit1 - Max_deficit2).max() / efficiencyPH + CBaseload.sum() * pow(10,3)
    GBio = resolution * bio_flexProportion * (Max_deficit1 - Max_deficit2).max() / efficiencyPH 
    GGas = resolution * (Max_deficit2).max() / efficiencyPH
    ...
    # Average annual electricity generated by existing capacity
    GGas = resolution * Deficit2.sum() / efficiencyPH / years
    GHydro = resolution * hydro_flexProportion * (Deficit1.sum() / years / efficiencyPH) - GGas
    GBio = resolution * bio_flexProportion * (Deficit1.sum() / years / efficiencyPH) - GGas - GHydro
